    ...
    <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-4">
      {loading ? (
        ...
        recipes.map((recipe) => (
          <button
            key={recipe.idMeal}
            className="border bg-white hover:bg-gray-100 p-4 w-full h-[320px] flex gap-2 flex-col items-center"
          >
            ...
            <div className="flex basis-1/4">
              {" "}
              <button
                onClick={() => countryClick(recipe.idMeal)}
                className="bg-orange-400 text-white px-6 text-xs h-8 rounded-md"
              >
                See recipe details...
              </button>
            </div>
        ...
        <div className="flex font-bold items-center justify-center h-[500px] col-span-3">
